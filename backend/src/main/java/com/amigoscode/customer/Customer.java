...
@Table(name = "customer", uniqueConstraints = {
        ...
        @UniqueConstraint(name = "customer_profile_image_id_unique", columnNames = "profileImageId") })
public class Customer implements UserDetails {
    ...
    public boolean equals(Object object) {
        ...
        return Objects.equals(id, customer.id) && Objects.equals(name, customer.name)
                ...
                && gender == customer.gender && Objects.equals(profileImageId, customer.profileImageId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, name, email, age, gender, profileImageId);
    }
